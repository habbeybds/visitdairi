          ...
          <div class="card form-style wrap-group-field wrapper-form">
            <div class="title-card">
              <h5>Data Pemesan</h5>
               ...
               <div class="wrap-form">
                   <form class="form" id="form-tour" method="post">
                    @csrf
                       <div class="row">
        ...
        <div class="col-12 col-md-4">
            <div class="card detail-pemesanan">
                ...
                <div class="date-book">
                    <h5>Date</h5>
                    <p class="info-date">
                        <i class="fas fa-calendar-alt"></i> {{ $cartData['schedule_date'] }}
                    </p>
                </div>
                <hr/>
                <div class="wrap-total-book">
                    <div>
                        <div class="body-price-details">
                            <ul>
                                <li>Basic Price<span></span></li>
                                <li>{{ $cart['quantity'] }}x @if($cartData['trip_type'] == 'OPEN')Orang @else Paket @endif <span>IDR. {{ number_format(($cart['quantity'] * $cartData['product_price']),0,'.','.') }}</span></li>
                            </ul>
                            <hr/>
                            <h5 class="total">Total <span>IDR. {{ number_format(($cart['quantity'] * $cartData['product_price']),0,'.','.') }}</span></h5>
                        </div>
                    </div>
                </div>
