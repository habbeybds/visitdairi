      ...
      <div class="col-12 col-md-8">
          ...
          <div class="card form-style wrap-group-field wrapper-form">
            <div class="title-card">
              <h5>Data Pemesan</h5>
               ...
               <div class="wrap-form">
                   <form class="form" id="form-kuliner" method="post">
                    @csrf
                       <div class="row">
        ...
        <div class="col-12 col-md-4">
            <div class="card detail-pemesanan">
                ...
                <p class="time-kurir">Waktu : <span>{{ $cartData['schedule_date'] }}</span></p>
                <p class="time-kurir">Jumlah Pax : <span>{{ $cartData['quantity'] }} Orang</span></p>
            </div>
        </div>
    </div>
  </div>
      ...
      $.post('{{ route('submitCheckout', $cartKey) }}', form.serialize(), function(response) {
        try{
          if(response.status == 'success') {
            ...
            window.location.href='{{ url('order/confirmation/') }}/' + code;  
          } else {
